...
import am.org.game.screen.GuideScreen;
...
public class MainGame extends ApplicationAdapter implements InputProcessor {
    ...
    private MyScreen _startScreen, _answerScreen, _guideScreen;
    public static int x;
    public static int y;
    ...
    public boolean keyDown(int keycode) {
        if (!_startScreen.keyDown(keycode)) {
            if(!_guideScreen.keyDown(keycode)) {
